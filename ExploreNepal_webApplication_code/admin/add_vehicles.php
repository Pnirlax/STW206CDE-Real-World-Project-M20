...
<body>
<!-- Header -->
<div id="header" style="background: #365d29;">
	<div class="shell">
...
">
					...
					<div class="box-content">
						...
						<p class="select-all"><input type="checkbox" class="checkbox" /><label style="color: #d92626;">select all</label></p>
						...
						<div class="sort">
							...
							<select class="field">
								<option value="">Hire Price per KM</option>
							</select>
						</div>
						<!-- End Sort -->
...
<!-- Footer -->
<div id="footer" style="background: #365d29;">
	<div class="shell">
		<span class="left">&copy; <?php echo date("Y");?> - ExploreNepal</span>
	</div>
</div>
<!-- End Footer -->
