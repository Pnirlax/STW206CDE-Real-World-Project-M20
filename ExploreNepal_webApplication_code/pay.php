	...
	<section class="listings">
		<div class="wrapper">
			<ul class="properties_list">
				<h1 style=style="text-decoration: underline;font-size: 25px;color: black;">Make Payments Here</h>
				<h5>Paybill Number: 00002</h5>
				<h6>Business Number: ID Number Registered with.</h6>
				<form method="post">
					<table>
						<tr>
							<td>ESewa ID:</td>
							<td><input type="text" name="Esewa" required></td>
						</tr>
						<tr>
