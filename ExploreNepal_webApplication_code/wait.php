	...
	<section class="listings">
		<div class="wrapper">
			<ul class="properties_list">
				<h2 style="text-align:center; color:#192045; font-family: 'Courier New', Courier, monospace">Thank you for sending a request to Explore Nepal. 
				We will get back to you once we verify your payment.<br>
				You can login to view the processing status of your request using your email and the Citizenship Number as password.</h2>
			</ul>
